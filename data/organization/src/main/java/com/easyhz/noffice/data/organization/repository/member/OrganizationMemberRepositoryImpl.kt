...
class OrganizationMemberRepositoryImpl @Inject constructor(
    ...
    override suspend fun fetchOrganizationPendingMembers(organizationId: Int): Result<List<Member>> =
        withContext(dispatcher) {
            return@withContext organizationMemberService.fetchOrganizationPendingMembers(
                organizationId
            )
    ...
    override suspend fun fetchOrganizationMembers(organizationId: Int): Result<List<Member>> =
        withContext(dispatcher) {
            return@withContext organizationMemberService.fetchOrganizationMembers(
                organizationId
